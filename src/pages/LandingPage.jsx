  ...
  return (
    <>
      ...
      <div className="mainFooterContainer">
        <div className="containerz1">
          {/* <img
            style={{ height: "30px" }}
            src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png?fit=around|198:42&crop=198:42;*,*"
            alt="logo"
          /> */}
          <p style={{fontStyle:"italic",fontSize:"45px",fontWeight:"bolder",margin:"0px 0px 0px 0px"}}>Tomato</p>
          <div className="options1">
            <div className="btnsFooter">
              <span className="indianFlag"></span>
              <span style={{ marginRight: "5px", marginLeft: "5px" }}>
                India
              </span>
              <i size="15" color="#1C1C1C">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="#1C1C1C"
                  width="15"
        ...
        <div style={{width:"70%"}}>
          <p style={{fontSize:"13px",color:"#4f4f4f"}}>By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2023 © Zomato™ Ltd. All rights reserved.</p>
        </div>
      </div>
    </>
  );
